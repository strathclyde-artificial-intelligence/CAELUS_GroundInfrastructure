...
drones = [Drone(uuid4(), Drone.TYPE_EVTOL_FW, "config_0") for _ in range(10)]
for drone in drones:
...
def test_transitions_are_stored_in_db():
    ...
    # Make two hospitals
    hospital1 = Hospital(uuid4(), 'Hospital1', [0.0, 0.0], "some_address")
    hospital2 = Hospital(uuid4(), 'Hospital2', [0.0, 0.0], "some_address")
